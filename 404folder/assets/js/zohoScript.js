...
function setAllDependancyFieldsMapping() {
	...
	if(mapDependancyLabels) {
		for(var i = 0; i < mapDependancyLabels.length; i++) {
			...
			var obj = document.forms['zsWebToCase_1082325000000300417'][label];
			if(obj) {
	...
	if(val != null && val != "" && val != "null" && mySelObject) {
		...
		for(var i in fields) {
			if(fields.hasOwnProperty(i)) {
				...
				var depObj = document.forms['zsWebToCase_1082325000000300417'][label];
...
function zsValidateMandatoryFields() {
	...
	for(var index = 0; index < zsWebFormMandatoryFields.length; index++) {
		isError = 0;
		var fieldObject = document.forms['zsWebToCase_1082325000000300417'][zsWebFormMandatoryFields[index]];
		if(fieldObject) {
	...
	if(isError == 0) {
		document.getElementById('zsSubmitButton_1082325000000300417').setAttribute('disabled', 'disabled');
	}
}
document.addEventListener('readystatechange', function() {
	...
	document.getElementById('zsSubmitButton_1082325000000300417').removeAttribute('disabled');
});
